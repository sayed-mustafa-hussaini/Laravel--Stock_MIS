...
@section('header-title')
    <li class="breadcrumb-item"> <a href="{{url('payments')}}">پرداخت ها</a></li>
@endsection
@section('css')
                ...
                <ul class="nav nav-tabs mb-5 nav-top-border no-hover-bg " role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center px-1" id="information-tab" data-toggle="tab"
                            ...
                            <i class="icon-clock mr-50"></i><span class="d-none d-sm-block"> لیست تمام پرداخت ها</span>
                        </a>
                    </li>
                </ul>
                                  ...
                                  <div class="card-body">
                                    <div class="media d-flex">
                                      ...
                                      <div class="media-body text-right total_NoPayments">
                                        ...
                                        <span>تعداد قرض های پرداخت نشده</span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content p-1">
            <div class="modal-header">
                <h5 class="modal-title">پرداخت قرض</h5>
            ...
            <form class="form" id="createform">
                <div class="modal-body">
                    ...
                    <div class="form-group div_goods_name">
                        <label for="loan_info">مشخضات قرض <span class="text-danger">*</span></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">اضافه کردن پرداخت </button> 
                </div>
            </form>
        </div>
    </div>
...
@section('javascript')
    ...
    <script>
        $('body').on('click', '.create', function() {
            ...
            var url='{{ url("payments") }}'+'/get_loans/all';
            ...
            $('#loan_info').on('change',function(){
                ...
                if(loan_id!=null){
                    var url='{{ url("payments") }}'+'/get_loan_quantity/'+loan_id;
    ...
    <script>
        $('body').on('click', '.edit', function() {
            ...
            var url_getLoan='{{ url("payments") }}'+'/get_loans/all_update/'+id;
            ...
            var url_edit='{{ url("payments") }}/'+id+'/edit';
            ...
            $('#edit_loan_info').on('change',function(){
                ...
                if(loan_id!=null){
                    var url='{{ url("payments") }}'+'/get_loan_quantity/'+loan_id+'/edit/'+id;
                    var loan_currency= $(this).find('option:selected').attr('data-currency'); 
                    $.get(url,function(data){
                        var quantity=data;
