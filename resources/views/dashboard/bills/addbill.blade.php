...
@section('header-title')
    ...
    <li class="breadcrumb-item"> اضافه کردن بل جدید</li>
@endsection
@section('css')
                ...
                <div class="card-body p-2">
                    ...
                    <div class="invoice-logo-title py-2">
                        <div class="row">
                            <div class="col-8">
                                ...
                                {{-- <span class="mb-50"> شماره تماس شرکت</span>
                                <span>
                                    <span class="font info">0787677334</span>
                                    <span class="font ml-50 info">0787677334</span>
                                </span> --}}
                            </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="d-flex align-items-center mb-1">
                                    <span > بل نمبر : </span>
                                    <span class="font ml-50">Bill-{{Helper::BillNum()}}</span>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex align-items-center justify-content-end justify-content-start">
                                    ...
                                    <span class="font ml-50" style="direction: ltr !important">
                                        @php
                                            echo $date= \Morilog\Jalali\CalendarUtils::strftime('Y / m / d', strtotime(now()));
                                        @endphp
                                    </span>
                                </div>
                            </div>
                    ...
                    <div class="row pb-3">
                        <div class="col-12 mb-2 text-right">
                            <button type="button" class="btn btn-primary btn-min-width create-customer" data-toggle="modal" data-target="#create-customer">
                                <i class="icon icon-plus mr-1"></i> اضافه کردن مشتری</button>
                            <button type="button" class="btn btn-success btn-min-width text-right create-customer-edit" data-toggle="modal" data-target="#create-customer-edit">
                                <i class="fa fa-pencil mr-50"></i> ویرایش کردن مشتری</button>
                        </div>
                        <div class="col-4 from-info">
                            <div class="company-name">
                                <span class="mr-50 text-primary">نام مشتری</span>: <span id="customer-name"></span>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="company-address">
                                <span class="mr-50 text-primary">شماره تماس</span>: <span id="customer-phone" class="font"></span>
                            </div>
                        </div>
                        <div class="col-4 to-info">
                            <div class="company-name">
                                <span class="mr-50  text-primary">ولایت</span>: <span id="customer-province"></span>
                            </div>
                        </div>
                    ...
                    <div class="product-details-table py-2 table-responsive">
                        ...
                        <div class="table-responsive mt-2">
                            <table id="purchases-table" class="table   text-center   table-white-space  row-grouping  no-wrap icheck table-middle" >
                                ...
                                <tbody id="html">
                                    <td valign="top" colspan="6" class="dataTables_empty">موردی اضافه نشده</td>
                                </tbody>
                            </table>
                        </div><!-- End Purchases Documents details table -->
                    </div>
                    
                    <form action="{{url('bill_details')}}" method="POST">
                        @csrf
                        <!-- total -->
                                ...
                                <div class="col-8 col-sm-6 d-flex justify-content-end mt-75">
                                    <ul class="list-group ">
                                        <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                            ...
                                            <span style="max-width:200px">
                                                <div class="input-group"> 
                                                    <input type="number" readonly class="form-control font" min="0"  name="total_goods" id="total_goods">
                                        ...
                                        <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                            ...
                                            <span style="max-width:200px">
                                                <div class="input-group"> 
                                                    <input type="number" readonly class="form-control font" min="0"  placeholder="مجموعه پول" name="total_money" id="total_money">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text bill-currency"></span>
                                                    </div>
                                                </div>
                                            </span> 
                                        </li>
                                        <li class="list-group-item border-0 p-50 d-flex justify-content-between my-1">
                                            ...
                                            <span style="max-width:200px;">
                                                <div class="input-group"> 
                                                    <input type="number" class="form-control font" style="width:160px !important;" required min="0"  placeholder="رسید" name="money_paid" id="money_paid" autocomplete="off">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text bill-currency"></span>
                                                    </div>
                                                </div>
                                        ...
                                        <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                            ...
                                            <span style="max-width:200px">
                                                <div class="input-group"> 
                                                    <input type="number" readonly class="form-control font" min="0" placeholder="باقی مانده" name="total_remain" id="total_remain">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text bill-currency"></span>
                                                    </div>
                                                </div>
                        ...
                        <div class="text-left mb-1 ">
                            <input type="hidden" id="bills_hidden_id" name="bills_hidden_id">
                            <button class="btn btn-primary print-invoice save-btn"> <i class="feather icon-printer mr-25 common-size" onclick="window.print()"></i> پرنت</button>
...
<!-- Create Modal -->
<div class="modal fade text-left" id="create-customer" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content p-1">
            ...
            <form class="form" id="createform-customer">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" readonly class="form-control font" name="bill_num"  min="0" value="{{Helper::BillNum()}}" id="bill_num">
                    </div>
                    <div class="form-group">
                        <fieldset>
                            <input type="checkbox" name="checkbox" id="checkbox" class="mr-25">
                            <label for="chekcbox">جستجوی مشتری در دیتابیس</label>
                        </fieldset>
                    </div>
                    <div class="customers-old">
                        <div class="form-group customer-div">
                            <label for="customer-old">نام مشتری <span class="text-danger">*</span></label>
                            <select class="select2 custom-select block customer-old" name="customer_old" style="width:100%" id="customer-old">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group province-div">
                                    ...
                                    <select class="select2 custom-select block province province1" name="province" style="width:100%" id="province">
        ...
        <div class="modal-content p-1">
            ...
            <form class="form" id="createform-customer-edit">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="bill_num"> بل نمبر <span class="text-danger">*</span></label>
                        <input type="number" readonly class="form-control font" name="bill_num"  min="0"  id="edit_bill_num">
                    </div>
                    <div class="form-group">
                        <fieldset>
                ...
                <div class="modal-footer">
                    <input type="hidden"   name="bill_hidden_id" id="bill_hidden_id">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control font" min="0" max="1000000" name="quantity_goods"  placeholder=" تعداد جنس " id="quantity_goods">
                        </div> 
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content p-1">
            ...
            <form class="form" id="editform">
                ...
                <div class="modal-footer">
                    <input type="hidden"   name="bill_hidden_id" id="edit_bill_hidden_id">
...
@section('javascript')
    ...
    <script>
        ...
        $('.create-customer-edit').css('display','none');
        ...
        $('#money_paid').attr('disabled','disabled');
    ...
    <script>
        $('body').on('click', '.create-customer', function() {
            $('#createform-customer').trigger("reset");
            $('.alert-create').hide();
            ...
            $('.province-div .select2-selection--single').removeClass(' border-danger');
            $('#currency').removeClass(' is-invalid');
            $('.customer-div .select2-selection--single').removeClass(' border-danger');
        });
        ...
        $("#createform-customer").submit(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#money_paid').removeAttr('disabled');
                    $('.create').removeAttr('disabled');
                    $('.create-customer').css('display','none');
                    $('.create-customer-edit').css('display','initial');
                    $('.create-customer-edit').attr('data-id',data['data'].bill_id);
                    $('.create').attr('data-id',data['data'].bill_id);
                    toastr.options = {
                        "closeButton": true,
                        "debug": true,
                        "newestOnTop": false,
                ...
                error: function(data) {
                    ...
                    $.each(data.responseJSON.errors, function(key, value) {
                        ...
                        if(key=='province'){
                            $('.province-div .select2-selection--single').addClass(' border-danger');
                        }
                        if(key=='currency'){
                            $('#currency').addClass(' is-invalid');
                        }
                        if(key=='customer_old'){
                            $('.customer-div .select2-selection--single').addClass(' border-danger');
                        }
                    });
                    $('.modal').animate({
                        scrollTop: 0
        ...
        $('#customer-old').on('change',function(){
            $('.customer-div .select2-selection--single').removeClass(' border-danger');
        }); 
    </script>{{-- End Create Customer --}}
    ...
    <script>
        $('body').on('click', '.create-customer-edit', function() {
            ...
            $.get(url,function(data){
                ...
                $('#edit_bill_num').val(data.bill_num);
                $('#bill_hidden_id').val(data.bill_id);
            });
        });
    ...
    <script>
        $('body').on('click', '.edit', function() {
            ...
            $.get(url,function(data){
                ...
                $('#edit_bill_hidden_id').val($('.create').attr('data-id'));                
