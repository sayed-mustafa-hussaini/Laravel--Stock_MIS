            ...
            <div class="card" >
                ...
                <div class="card-body p-2">
                    ...
                    <div class="product-details-table py-2 table-responsive">
                        @error('error')
                            <div class="alert alert-danger mb-2 alert-error">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="table-responsive mt-2">
                            <table id="purchases-table" class="table   text-center   table-white-space  row-grouping  no-wrap icheck table-middle" >
                                ...
                                <tbody id="html">
                                    @php $counter=1; $total_goods=0; $total_price=0; @endphp
                                    @foreach ($billDocuments as $row)
                                        <tr id="row{{$row->id}}">
                                            ...
                                            @php
                                                ...
                                                $total_goods+=$row->quantity_goods;
                                                $total_price+=$money;
                                            @endphp
                    ...
                    <form action="{{url('incomplate_bill_details')}}" method="POST">
                        @csrf
                        <!-- total -->
                                ...
                                <div class="col-8 col-sm-6 d-flex justify-content-end mt-75">
                                    <ul class="list-group ">
                                        <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                            ...
                                            <span style="max-width:200px">
                                                <div class="input-group"> 
                                                    <input type="number" readonly class="form-control font" min="0" value="{{$total_goods}}"   name="total_goods" id="total_goods">
                                        ...
                                        <li class="list-group-item each-cost border-0 p-50 d-flex justify-content-between">
                                            ...
                                            <span style="max-width:200px">
                                                <div class="input-group"> 
                                                    <input type="number" readonly class="form-control font" min="0" value="{{$total_price}}"  placeholder="مجموعه پول" name="total_money" id="total_money">
                                                    <div class="input-group-append">
                                        ...
                                        <li class="list-group-item border-0 p-50 d-flex justify-content-between my-1">
                                            ...
                                            <span style="max-width:200px;">
                                                <div class="input-group"> 
                                                    <input type="number" class="form-control font" style="width:160px !important;" max="{{$total_price}}"  value="{{$bills->money_paid}}" required min="0"  placeholder="رسید" name="money_paid" id="money_paid" autocomplete="off">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text bill-currency"> {{$bills->currency}} </span>
                                                    </div>
                                                </div>
